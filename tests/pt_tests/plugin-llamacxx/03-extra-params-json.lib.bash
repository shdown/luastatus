...
widget = {
    ...
    opts = {
        ...
        extra_params_json = '"max_tokens":123',
    },
    cb = function(t)
...
fakellama_expect_req '{"prompt":"Marco...","response_fields":["content"],"cache_prompt":true,"max_tokens":123}'

pt_expect_line 'cb answer Polo!' <&$pfd
